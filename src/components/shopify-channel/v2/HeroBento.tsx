...
const HeroBento = () => {
  return (
    <section className="relative pt-28 pb-16 md:pt-36 md:pb-24 bg-[hsl(var(--surface-navy))] text-white overflow-hidden">
      ...
      />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] rounded-full opacity-10 blur-[120px] bg-white" />
          ...
          >
            ...
            <h1 className="mt-6 text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[0.98]">
              ...
              <span className="bg-gradient-to-r from-white via-white to-[hsl(var(--orange-glow))] bg-clip-text text-transparent">
                <TranslatedText>engineered for scale.</TranslatedText>
              </span>
            </h1>

            <p className="mt-6 text-lg md:text-xl text-white/70 max-w-xl leading-relaxed">
              <TranslatedText>
                Same-day pick &amp; pack, photo-proof QC, and branded unboxing — operated from our Los Angeles warehouse for DTC brands shipping nationwide.
              </TranslatedText>
            </p>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                to="/contact"
                className="group inline-flex items-center gap-2 px-7 py-4 rounded-xl bg-[hsl(var(--orange-glow))] text-white font-bold hover:-translate-y-0.5 transition-all shadow-[0_20px_60px_-15px_hsl(var(--orange-glow)/0.6)]"
              >
            ...
            <div className="mt-10 grid grid-cols-3 gap-4 max-w-lg">
              {[
                { v: "400K+", l: "Orders shipped" },
                { v: "99.2%", l: "Same-day rate" },
                { v: "<24h", l: "Onboarding" },
              ].map((s) => (
            ...
            <div className="relative rounded-3xl overflow-hidden border border-white/10 aspect-[4/5] lg:aspect-auto lg:h-full min-h-[480px]">
              ...
              <div className="absolute top-5 left-5 flex flex-col gap-2.5">
                <div className="inline-flex items-center gap-2 px-3 py-2 rounded-xl bg-[hsl(var(--surface-navy))]/80 backdrop-blur-md border border-white/15 text-xs font-semibold">
                  ...
                  <TranslatedText>Photo-proof QC on every order</TranslatedText>
                </div>
              </div>
              <div className="absolute bottom-5 right-5 px-4 py-3 rounded-xl bg-white text-[hsl(var(--surface-navy))] shadow-2xl">
                ...
                <div className="text-2xl font-bold tracking-tight mt-0.5">2:00 PM PT</div>
              </div>
            </div>
          </motion.div>
        </div>

        {/* bottom inline links for SEO */}
        <div className="mt-10 text-sm text-white/50">
          <TranslatedText>Explore our</TranslatedText>{" "}
          <Link to="/why-choose-us" className="text-white/80 hover:text-[hsl(var(--orange-glow))] underline-offset-4 hover:underline">
            <TranslatedText>fulfillment approach</TranslatedText>
          </Link>
          {", "}
          <Link to="/kitting-bundling" className="text-white/80 hover:text-[hsl(var(--orange-glow))] underline-offset-4 hover:underline">
            <TranslatedText>custom kitting</TranslatedText>
          </Link>
          {", "}
          <Link to="/" className="text-white/80 hover:text-[hsl(var(--orange-glow))] underline-offset-4 hover:underline">
            <TranslatedText>and our Los Angeles fulfillment center</TranslatedText>
          </Link>
          .
        </div>
      </div>
