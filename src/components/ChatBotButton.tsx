      ...
      {!isOpen && (
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="relative w-[72px] h-[72px] rounded-full bg-gradient-to-br from-[hsl(28,100%,50%)] to-[hsl(28,100%,40%)] text-white shadow-xl shadow-[hsl(28,100%,50%)]/30 flex items-center justify-center focus:outline-hidden focus:ring-2 focus:ring-[hsl(28,100%,50%)] focus:ring-offset-2 group"
          ...
          >
            ...
            <MessageCircle className="w-8 h-8 drop-shadow-xs" />
          </motion.button>
        </motion.div>
      )}
    </AnimatePresence>
