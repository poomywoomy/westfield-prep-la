...
import AddMonthlyBillingItemDialog from "./AddMonthlyBillingItemDialog";
import AddMonthlyBillingPaymentDialog from "./AddMonthlyBillingPaymentDialog";
...
const BillingEntryDialog = ({
  ...
  return (
    <>
      ...
      {currentCycle && (
        <AddMonthlyBillingPaymentDialog
