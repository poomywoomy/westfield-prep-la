    ...
    <section className="py-24 md:py-32 bg-white">
      <div className="container mx-auto px-4">
        <div className="relative rounded-3xl bg-[hsl(var(--surface-navy))] text-white p-10 md:p-20 overflow-hidden border border-white/10 text-center">
          ...
          <div className="absolute -bottom-32 left-1/2 -translate-x-1/2 w-[800px] h-[400px] rounded-full opacity-15 blur-[120px]" style={{ background: "hsl(var(--orange-glow))" }} />
          <div className="relative max-w-3xl mx-auto">
            ...
            <div className="mt-10 flex flex-wrap gap-3 justify-center">
              ...
              <Link to="/pricing" className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white/5 border border-white/15 text-white font-semibold hover:bg-white/10 backdrop-blur-sm">
