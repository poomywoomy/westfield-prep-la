        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              See how we helped an Amazon seller transform their FBA operations.
            </p>
          </div>
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row gap-8 md:gap-12">
                ...
                <div className="md:w-1/2">
                  ...
                  <h3 className="text-2xl font-bold mb-4 text-foreground">
                    From Garage Operations to 50K Units/Month
                  </h3>
                  <div className="space-y-4 text-muted-foreground">
                    <p>
                      <strong className="text-foreground">The Challenge:</strong> This seller was 
                      prepping FBA shipments in their garage, spending 40+ hours weekly on labeling 
                      and packaging. Frequent compliance issues led to IPI score drops and stranded inventory.
                    </p>
                    <p>
                      <strong className="text-foreground">Our Solution:</strong> We took over all 
                      prep operations, implementing strict QC protocols and same-day receiving. 
                      Photo documentation gave them visibility without the hands-on work.
                    </p>
                    <p>
                      <strong className="text-foreground">The Result:</strong> In 6 months, they 
                      scaled from 8,000 to 50,000 units monthly while reducing prep errors to 
                      near-zero. Their IPI score recovered to 600+, and they reclaimed 40+ hours 
                      per week to focus on sourcing and growth.
                    </p>
                  </div>
                </div>
                    ...
                    {[
                      {
                        ...
                        value: "6x",
                        label: "Volume Growth",
                        detail: "8K → 50K units/mo",
                      },
                      {
                        icon: Clock,
                        value: "40+",
                        label: "Hours Saved Weekly",
                        detail: "Fully outsourced prep",
                      },
                      {
                        icon: Package,
                        value: "99.8%",
                        label: "Prep Accuracy",
                        detail: "Near-zero errors",
                      },
                      {
                        icon: DollarSign,
                        value: "600+",
                        label: "IPI Score",
                        detail: "Account health restored",
                      },
                    ].map((metric, index) => (
                      <motion.div
                        key={index}
              ...
              <div className="mt-8 pt-8 border-t border-orange-200 flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button asChild variant="outline" className="border-orange-300 hover:bg-orange-50">
                  <Link to="/why-choose-us">See More Results</Link>
                </Button>
              </div>
            </div>
          </div>
