  ...
  return (
    <section className="relative py-24 overflow-hidden bg-gradient-to-br from-slate-900 via-orange-950 to-slate-900">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-0 left-0 w-80 h-80 bg-amber-500 rounded-full blur-3xl opacity-10"
          animate={{
            scale: [1, 1.3, 1],
            y: [0, -40, 0],
          }}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            We've helped hundreds of Amazon sellers scale their FBA business with 
            reliable, compliant prep services that protect their accounts.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {metrics.map((metric, index) => (
            <motion.div
              ...
              className="relative p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 hover:border-orange-500/30 transition-all duration-300"
            >
