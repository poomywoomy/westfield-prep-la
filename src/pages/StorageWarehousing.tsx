...
const StorageWarehousing = () => {
  ...
  const serviceData = {
    ...
    description:
      "Secure 3PL warehouse storage in Los Angeles. Climate-controlled prep center with pallet storage, lot control, and cycle counts for e-commerce inventory management.",
