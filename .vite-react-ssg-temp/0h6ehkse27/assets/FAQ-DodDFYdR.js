...
import { S as StructuredData, w as westfieldLogo, B as Button, T as TranslatedText, A as Accordion, a as AccordionItem, b as AccordionTrigger, c as AccordionContent, F as Footer } from "../main.mjs";
...
const FAQ = () => {
  ...
  const faqCategories = [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          question: "Can I schedule a virtual walkthrough?",
          answer: "We offer virtual warehouse walkthroughs and video calls for prospective clients. Contact us to schedule a virtual tour where we'll show you our operations, security measures, and answer any questions about our processes."
        },
        {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs(Head, { children: [
      /* @__PURE__ */ jsx("title", { children: "Comprehensive FAQ - Westfield Prep Center | Shopify, Amazon FBA & TikTok Shop" }),
      /* @__PURE__ */ jsx("meta", { name: "description", content: "Get answers to 90+ questions about Shopify fulfillment, Amazon FBA prep, TikTok Shop logistics, pricing, shipping, and e-commerce operations in Los Angeles." }),
      /* @__PURE__ */ jsx("link", { rel: "canonical", href: "https://westfieldprepcenter.com/faq" }),
      /* @__PURE__ */ jsx("meta", { property: "og:title", content: "Comprehensive FAQ - Westfield Prep Center" }),
      /* @__PURE__ */ jsx("meta", { property: "og:description", content: "Get answers to 90+ questions about Shopify fulfillment, Amazon FBA prep, TikTok Shop logistics, pricing, shipping, and e-commerce operations." }),
      /* @__PURE__ */ jsx("meta", { property: "og:url", content: "https://westfieldprepcenter.com/faq" }),
      ...
      /* @__PURE__ */ jsx("meta", { name: "twitter:title", content: "Comprehensive FAQ - Westfield Prep Center" }),
      /* @__PURE__ */ jsx("meta", { name: "twitter:description", content: "Get answers to 90+ questions about Shopify fulfillment, Amazon FBA prep, TikTok Shop logistics, pricing, shipping, and e-commerce operations." }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
      ...
      /* @__PURE__ */ jsx("main", { className: "container mx-auto px-4 py-12", children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-4xl md:text-5xl font-bold text-primary mb-4", children: /* @__PURE__ */ jsx(TranslatedText, { children: "Comprehensive FAQ" }) }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mb-8", children: /* @__PURE__ */ jsx(TranslatedText, { children: "Everything you need to know about Shopify fulfillment, Amazon FBA prep, TikTok Shop logistics, and more" }) })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mb-8 p-6 bg-muted/30 rounded-lg", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-semibold mb-4 text-foreground", children: /* @__PURE__ */ jsx(TranslatedText, { children: "Quick Navigation" }) }),
          /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: faqCategories.map((category, idx) => /* @__PURE__ */ jsxs(
            Button,
            {
              variant: "outline",
              size: "sm",
              ...
              children: [
                category.emoji,
                " ",
                /* @__PURE__ */ jsx(TranslatedText, { children: category.title })
              ]
            },
            idx
          )) })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "space-y-4", children: faqCategories.map((category, catIndex) => /* @__PURE__ */ jsx("div", { id: `category-${catIndex}`, children: /* @__PURE__ */ jsxs(Collapsible, { defaultOpen: catIndex === 0 || catIndex === 3 || catIndex === 4, children: [
          /* @__PURE__ */ jsxs(CollapsibleTrigger, { className: "flex w-full items-center justify-between rounded-lg border border-border bg-card p-4 hover:bg-muted/50 transition-colors", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsx("span", { className: "text-2xl", children: category.emoji }),
              /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsx("span", { className: "text-xl font-bold text-foreground", children: /* @__PURE__ */ jsx(TranslatedText, { children: category.title }) }),
            ...
            /* @__PURE__ */ jsx(ChevronDown, { className: "h-5 w-5 shrink-0 transition-transform duration-200 data-[state=open]:rotate-180" })
          ] }),
          /* @__PURE__ */ jsx(CollapsibleContent, { className: "pt-4", children: /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, className: "w-full space-y-2", children: category.questions.map((faq, qIndex) => /* @__PURE__ */ jsxs(
            AccordionItem,
            {
              value: `${catIndex}-${qIndex}`,
              className: "bg-card border border-border rounded-lg px-4",
              children: [
                /* @__PURE__ */ jsx(AccordionTrigger, { className: "text-left font-semibold text-foreground hover:text-primary py-4", children: /* @__PURE__ */ jsx(TranslatedText, { children: faq.question }) }),
                /* @__PURE__ */ jsx(AccordionContent, { className: "text-muted-foreground pb-4", children: /* @__PURE__ */ jsx(TranslatedText, { children: faq.answer }) })
              ]
            },
            qIndex
          )) }) })
        ] }) }, catIndex)) }),
        /* @__PURE__ */ jsxs("section", { className: "mt-12 text-center py-12 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-lg border border-border", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-bold text-primary mb-4", children: /* @__PURE__ */ jsx(TranslatedText, { children: "Still Have Questions?" }) }),
          /* @__PURE__ */ jsx("p", { className: "text-lg text-muted-foreground mb-6 max-w-2xl mx-auto", children: /* @__PURE__ */ jsx(TranslatedText, { children: "Our team is here to help. Contact us for personalized answers and custom pricing quotes tailored to your business needs." }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex gap-4 justify-center flex-wrap", children: [
            /* @__PURE__ */ jsx(Link, { to: "/contact", children: /* @__PURE__ */ jsx(Button, { size: "lg", className: "bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold", children: /* @__PURE__ */ jsx(TranslatedText, { children: "Contact Us" }) }) }),
            /* @__PURE__ */ jsx(Button, { size: "lg", variant: "outline", asChild: true, children: /* @__PURE__ */ jsxs("a", { href: "tel:+18189355478", className: "font-semibold", children: [
              "📞 ",
              /* @__PURE__ */ jsx(TranslatedText, { children: "Call" }),
              " (818) 935-5478"
            ] }) })
          ] })
        ] })
